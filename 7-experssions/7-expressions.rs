/*
 *  a rust program is mostly made up of a series of statements, ie:
 *  fn main()
 *      //statement
 *      //statement
 *      //statement
...
/*
*  there are a few kinds of statemtnts in rust, the most common two are declaring a variable
*  binding , and using a ; with expression:
*
*  fn main() {
*      // variable binding
*      let x = 5;
